...
from hybrid_frame_mapper import demo_sentences
...
const STRESS_SAMPLE=__STRESS_SAMPLE__;
...
</script></body></html>""".replace("__STRESS_SAMPLE__", json.dumps(demo_sentences()))
